...
from ...booking import error_codes as booking_error_codes
...
def to_enum(enum_cls, *, type_name=None, **options) -> graphene.Enum:
    ...
    choices = enum_cls.CHOICES if hasattr(enum_cls, "CHOICES") else enum_cls.choices
...
BookingErrorCode = graphene.Enum.from_enum(booking_error_codes.BookingErrorCode)
CoreErrorCode = graphene.Enum.from_enum(core_error_codes.CoreErrorCode)
